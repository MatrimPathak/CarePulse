			...
			>
				...
				<div className="flex flex-col gap-6 xl:flex-row">
					<CustomFormField
						...
						placeholder="Mother had diabetes, Father had heart disease, etc."
					/>
					<CustomFormField
						control={form.control}
						fieldType={FormFieldType.TEXTAREA}
				...
				<CustomFormField
					...
					label="I consent to the disclosure of my health information for treatment purposes."
				/>
				<CustomFormField
					control={form.control}
					fieldType={FormFieldType.CHECKBOX}
					name="privacyConsent"
					label="I acknowloedge that I have reviewed and agree to the privacy policy."
				/>
